...
<%
	...
	String pname=request.getParameter("productsearch");
	String mname=request.getParameter("materialsearch");
%>
<head>
...
<div class="container-fluid mt-2 mb-5">
	...
	<div class="row mt-4">
		...
		<div class="col-md-2 mt-6" style="font-size: 13px;">
			<form method='post' action="produce_listAction.jsp">
			<br>
				<h2>생산 목록</h2>
				<hr>
			  	  <div class="form-row">
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">생산목록 추가</button>
				  	</div>
				  </div>
		...
		<div class="col-md-10">
			<!-- 검색옵션 -->
			<form action='produce_listsearch.jsp'>
			<h3>검색</h3>
			<div class="form-row">
				<div class="form-group col-sm-4">
					<label>생산코드</label>
					<input type="number" min="0" name="searchId" class="form-control form-control-sm" id="searchId" placeholder="생산ID">   
				</div>
				<div class="form-group col-sm-4">
					<label>제품명</label>
			...
			for(ProductionListDTO dto:list){
				if(Integer.toString(dto.getP_AMOUNT()).contains(pid) && dto.getPRODUCT_ID().contains(pname) && dto.getMATERIALS_ID().contains(mname)){
			 %>
			    <tr align="center">
			      <td><%=i++ %></td>
