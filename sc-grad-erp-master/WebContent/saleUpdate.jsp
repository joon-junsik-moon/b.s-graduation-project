...
<%
	...
	if(request.getParameter("saleId")!=null && request.getParameter("productlist")!=null && request.getParameter("clientlist")!=null
		...
		s.UpdateSaleData(sid, client, product, amount, unit, price, date, employee);
		%>
		<script>
				...
				<hr>
				  ...
				  <div class="form-row">
				    	...
				    	<select name="employeelist" class="form-control form-control-sm" id="employeelist">
				    		...
				    		for(EmployeeDTO dto: e){
				    			if(dto.getE_NAME().equals(update.getSALE_EID())){%>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">판매 수정</button>
				  	</div>
				  </div>
