...
<%
	...
	if(request.getParameter("materialId")!=null && request.getParameter("materialName")!=null && request.getParameter("price")!=null){
		...
		s.InsertMaterialsData(id, name, price);
		%>
		<script>
...
<div class="container-fluid mt-2 mb-5">
	...
	<div class="row mt-4">
		<!-- 자재관리 폼 시작 -->
		<div class="col-md-4 mt-6" style="font-size: 13px;">
			<form method='post'>
			<br>
				<h2>자재 관리</h2>
				<hr>
		...
		<div class="col-md-8">
			...
			<!-- 검색옵션끝 -->
			<!-- 데이터 열람테이블 -->
			<table id="foo-table" class="table table-hover" style="width:950px; font-size:13px;">
