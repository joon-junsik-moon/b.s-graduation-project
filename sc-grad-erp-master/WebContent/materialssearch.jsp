	...
	<div class="row mt-4">
				...
				<hr>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm" onclick="location.href='materials.jsp'">자재 등록</button>
				  	</div>
				  </div>
			</form>
		</div>
		...
		<div class="col-md-10">
			...
			for(MaterialsDTO dto:list){
				if(dto.getMATERIALS_ID().contains(sid) && dto.getMATERIALS_NAME().contains(sname)){
			 %>
			    <tr align="center">
			      <td><%=i++ %></td>
