...
&& request.getParameter("produceDate")!=null && request.getParameter("amount")!=null){
	...
	s.UpdateProductionManagementData(product, amount, date, employee);
	%>
	<script>
				...
				<hr>
				  <div class="form-row">
				    <div class="form-group col-sm-6">
				    	<label>생산 제품</label>
				    	<select name="productlist" class="form-control form-control-sm" id="productlist" readonly>
							<%
				    		ArrayList<ProductDTO> m=s.ProductList(); 
				    		for(ProductDTO dto: m){
				    			if(update.getPRODUCTION_CODE().contains(dto.getPRODUCT_NAME())){%>
