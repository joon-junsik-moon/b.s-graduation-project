		...
		<div class="col-md-10">
			...
			int i=1;
			 for(EmployeeDTO dto:list){
					if(dto.getE_NAME().contains(sname) && dto.getDEPARTMENT().contains(sdep) && dto.getE_POSITION().contains(srank) && ((std.compareTo(dto.getJOIN_DATE())<=0)||std.equals(""))&&((edd.compareTo(dto.getJOIN_DATE())>=0)||edd.equals(""))){
					 %>
					    <tr align="center">
					      <td><%=i++ %></td>
					      <td><%=dto.getEID() %></td>
