...
<%
	...
	if(request.getParameter("purchaseId")!=null && request.getParameter("materiallist")!=null && request.getParameter("clientlist")!=null
		...
		s.UpdatePurchaseData(pid, material, client, amount, unit, price, date, employee);//client 삭제============
		%>
		<script>
			...
			<br>
				...
				<hr>
			  	  <div class="form-row">
				    	...
				    	<label>구매코드</label>
				    	<input type="number" min="0" name="purchaseId" class="form-control form-control-sm" id="purchaseId" placeholder="구매ID" value=<%=update.getPURCHASE_CODE() %> readonly>
				      </div>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">구매 수정</button>
				  	</div>
				  </div>
			</form>
		</div>
